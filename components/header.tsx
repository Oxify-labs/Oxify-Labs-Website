...
export function Header() {
    ...
    return (
        <header className="fixed top-4 left-0 right-0 z-50 px-6 mt-4">
            <div className="mx-auto max-w-7xl w-full grid grid-cols-[1fr_auto_1fr] items-center gap-4">
                {/* Left: Brand */}
                <Link href="/" className="justify-self-start inline-flex flex-col leading-none">
                    <span className="font-heading italic text-white text-xl md:text-2xl tracking-tight">
                        Oxify Labs
                    </span>
                </Link>
