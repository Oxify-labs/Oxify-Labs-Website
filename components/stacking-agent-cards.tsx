...
const AGENTS = [
  {
    ...
    desc: "The blueprint before the build. Every engagement starts with mapping the full technical landscape — data flows, interfaces, dependencies — before anyone opens an editor.",
    stats: [{ v: "Every project", l: "starts here" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/researcher-CvhqOuV6irGwBOnJoTGFlXdbyYBRjb.png",
  },
  {
    label: "ENGINEER",
    title: "Full-stack development",
    desc: "React, Node, Python, Solidity — whatever the problem demands. We write code that belongs in production, not just in a demo. Typed, reviewed, and built to hand over.",
    stats: [{ v: "Clean code", l: "always" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/coder-9bItvCegU6TXUqbX3tUXGBAtvkBkXp.png",
  },
  {
    label: "RESEARCHER",
    title: "Applied research",
    desc: "Emerging tech without the hype. We evaluate, prototype, and integrate new technology against real production requirements — not pitch decks.",
    stats: [{ v: "Built for", l: "the real world" }],
  ...
  },
  {
    ...
    desc: "Zero to production. Scoped tight, built fast, structured to survive contact with real users from the moment it ships.",
    stats: [{ v: "Zero to", l: "production" }],
