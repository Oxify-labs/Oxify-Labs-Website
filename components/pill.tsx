...
export const Pill = ({ children, className }: { children: React.ReactNode, className?: string }) => {
  ...
  return (
    <div
      ...
      className={cn("bg-white/5 transform-gpu font-medium text-foreground/70 backdrop-blur-md font-mono text-xs tracking-wider inline-flex items-center justify-center px-4 h-8 border border-white/10 shadow-[0_0_15px_-5px_theme(colors.primary.DEFAULT)] [clip-path:polygon(var(--poly-roundness)_0,calc(100%_-_var(--poly-roundness))_0,100%_var(--poly-roundness),100%_calc(100%_-_var(--poly-roundness)),calc(100%_-_var(--poly-roundness))_100%,var(--poly-roundness)_100%,0_calc(100%_-_var(--poly-roundness)),0_var(--poly-roundness))]", className)}
    >
