  ...
  return (
    <main className="relative z-10 min-h-screen pt-28 sm:pt-32 pb-20 px-4 sm:px-6 md:px-10 lg:px-16">
      <section className="mx-auto max-w-4xl liquid-glass rounded-2xl p-6 sm:p-8 md:p-10">
        ...
        <div className="mb-8">
          <a
            href="mailto:oxifyhq@gmail.com?subject=Project%20Inquiry"
            className="liquid-glass-strong rounded-xl px-5 py-4 text-white font-medium flex items-center gap-3"
          >
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-4 h-4 text-white/60 shrink-0">
          ...
          <div className="flex flex-wrap items-center gap-3">
            {SOCIALS.map((social) => (
              <a
                ...
                className="liquid-glass rounded-xl px-4 py-3 flex items-center gap-2.5 text-white/70 hover:text-white transition-colors text-sm font-medium"
              >
                {social.icon}
                {social.name}
              </a>
